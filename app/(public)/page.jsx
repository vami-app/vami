  ...
  return (
    <div className="layout-main">
      ...
      <section className="hero-section" aria-label="Hero showcase">
        <div className="relative w-full min-h-[85dvh] lg:min-h-[92dvh] rounded-[var(--outer-radius)] overflow-hidden shadow-card flex flex-col justify-center border border-black/5 bg-gray-900">
          ...
          <div className="relative z-20 flex flex-col items-center text-center p-[var(--space-6)] pt-28 lg:pt-[var(--space-6)] transform transition-transform duration-700 translate-y-0 opacity-100 mt-20">
            ...
            <h1 className="font-headline font-light text-white leading-[1.1] tracking-tight max-w-4xl text-4xl sm:text-5xl md:text-6xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-4">
              <Link
                href="/products"
                className="inline-flex justify-center items-center px-8 py-4 bg-white text-black rounded-full text-[var(--text-cta)] font-medium shadow-cta hover:bg-gray-100 transition-colors"
              >
                Browse Catalog <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
              <Link
                href="/contact"
                className="inline-flex justify-center items-center px-8 py-4 bg-black/40 text-white border border-white/20 rounded-full text-[var(--text-cta)] font-medium hover:bg-black/60 transition-colors"
              >
                Request Quote
              </Link>
            </div>
      ...
      <section className="w-full overflow-hidden py-12 sm:py-16 lg:py-20 bg-white border-y border-black/5">
        <div className="flex w-max animate-scroll opacity-60 hover:opacity-100 transition-opacity duration-500">
          <div className="flex items-center gap-16 sm:gap-24 md:gap-32 pr-16 sm:pr-24 md:pr-32 text-lg sm:text-xl text-gray-900">
          ...
          <div
            className="flex items-center gap-16 sm:gap-24 md:gap-32 pr-16 sm:pr-24 md:pr-32 text-lg sm:text-xl text-gray-900"
            aria-hidden="true"
          >
            <div className="font-bold tracking-tight">COPPER-NICKEL</div>
            <div className="tracking-widest font-light">ALUMINUM BRONZE</div>
          ...
          <section className="pt-20 sm:pt-24 lg:pt-32 pb-8 sm:pb-12 w-full">
            <div className="w-full max-w-[var(--max-width-layout)] mx-auto px-[var(--gap)]">
              <div className="max-w-3xl">
                ...
                <h2 className="font-headline font-light text-gray-900 mt-4 leading-tight text-3xl sm:text-4xl lg:text-5xl text-balance">
                  Precision cast,
          ...
          <section className="pb-16 lg:pb-24 w-full">
            <div className="w-full max-w-[var(--max-width-layout)] mx-auto px-[var(--gap)]">
              <div className="border border-black/10 rounded-[var(--outer-radius)] overflow-hidden flex flex-col lg:flex-row w-full bg-white shadow-sm">
                <div className="w-full lg:w-5/12 flex flex-col p-6 sm:p-8 lg:p-12 justify-between">
                  <div className="w-full">
                    <div className="flex items-center gap-3 mb-4 sm:mb-6">
                      ...
                      />
                      <h2
                        className="font-headline font-light text-gray-900 tracking-tight text-2xl sm:text-3xl lg:text-4xl line-clamp-2"
                    ...
                    <p
                      className="text-gray-500 text-sm sm:text-base mb-8 lg:mb-12 leading-relaxed font-light line-clamp-4"
                  ...
                  <div className="space-y-4 mt-auto">
                    <div className="group cursor-pointer">
                      <div className="border-t border-black/10 pt-4 sm:pt-6 pb-2 sm:pb-4 relative overflow-hidden">
                        <div className="absolute top-0 left-0 h-[2px] bg-black w-1/3 transition-all duration-500 group-hover:w-full"></div>
                        <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-2 transition-colors">
                          Technical Specifications
                        </h3>
                        <p className="text-sm text-gray-500 leading-relaxed pr-4 font-light">
                ...
                <div className="w-full lg:w-7/12 relative flex items-center justify-center overflow-hidden group p-4 sm:p-6 lg:p-8 min-h-[400px] lg:min-h-[auto] border-t lg:border-t-0 lg:border-l border-black/10 bg-gray-50">
                  <img
                  ...
                  <div className="relative z-10 w-full max-w-sm rounded-[var(--inner-radius)] p-6 sm:p-8 shadow-xl bg-white space-y-4 sm:space-y-6 transform transition-transform duration-500 hover:-translate-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1 sm:space-y-2">
                        ...
                        <div className="text-base sm:text-xl font-light text-gray-900">
                          99.9%
                        </div>
      ...
      <section className="py-16 sm:py-20 lg:py-28 w-full bg-[#f9f9f9]">
        <div className="w-full max-w-[var(--max-width-layout)] mx-auto px-[var(--gap)]">
          ...
          <div className="mt-16 pt-8 border-t border-black/5 text-center">
            <Link
              href="/products"
              className="inline-flex justify-center items-center px-8 py-4 bg-white border border-black/10 text-black rounded-full text-[var(--text-cta)] font-medium shadow-sm hover:bg-gray-50 transition-colors"
            >
              View All Categories
            </Link>
          </div>
