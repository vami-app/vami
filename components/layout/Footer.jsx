          ...
          <div className="w-full min-h-[400px] sm:min-h-[500px] rounded-[var(--outer-radius)] flex flex-col justify-between relative border border-border-subtle bg-background p-6 sm:p-10 lg:p-16 overflow-hidden shadow-sm">
              ...
              <div className="lg:w-7/12 grid grid-cols-1 sm:grid-cols-2 gap-8 lg:justify-items-end lg:text-right">
                <div className="lg:text-left w-full max-w-[280px]">
                  ...
                  <ul className="space-y-4">
                    <li>
                      <a href="mailto:radhemetalalloysllp@gmail.com" className="flex items-center text-sm text-text-muted hover:text-text-primary font-light transition-colors">
                        <Mail className="flex-shrink-0 h-4 w-4 mr-3 text-text-muted" />
                        radhemetalalloysllp@gmail.com
                      </a>
                    </li>
                    <li>
                      <a href="tel:+919081358107" className="flex items-center text-sm text-text-muted hover:text-text-primary font-light transition-colors">
            ...
            <div className="flex flex-col w-full gap-4 mt-16 sm:mt-auto z-10">
              <div 
                ...
                style={{ fontSize: 'clamp(1.5rem, 6vw, 6rem)', marginLeft: '-0.05em', lineHeight: '0.85' }}
              >
                RADHEY METAL ALLOYS.
              </div>
