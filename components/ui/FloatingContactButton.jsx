        ...
        <div className="absolute right-[var(--gap)] bottom-0 flex flex-col items-center gap-4 pointer-events-auto">
          ...
          >
            <a 
              ...
              className="group flex items-center justify-center h-12 w-12 sm:h-14 sm:w-14 rounded-full bg-surface border border-border-subtle shadow-lg hover:bg-surface-muted transition-colors relative"
          ...
          <button 
            onClick={toggleOpen}
            className="flex items-center justify-center h-14 w-14 sm:h-16 sm:w-16 rounded-full bg-text-primary text-text-inverse shadow-xl hover:scale-105 transition-transform duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black"
