        ...
        <div className="absolute right-[var(--gap)] bottom-0 flex flex-col items-center gap-4 pointer-events-auto">
          ...
          >
            <a 
              ...
              title="Send Email"
            >
              <Icon icon={Mail} size="md" className="text-text-primary" />
          ...
          <Button 
            size="icon"
            onClick={toggleOpen}
            className="h-14 w-14 sm:h-16 sm:w-16 shadow-xl hover:scale-105 transition-transform duration-300 rounded-full"
            aria-label="Contact options"
          >
            {isOpen ? (
              <Icon icon={X} size="lg" />
            ) : (
              <Icon icon={Contact} size="lg" />
            )}
          </Button>
