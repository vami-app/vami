...
export function ThemeToggle({ className = '' }) {
  ...
  return (
    <Button
      ...
      className={`relative inline-flex items-center justify-center rounded-full border border-border-subtle bg-surface hover:bg-surface-muted text-text-secondary hover:text-text-primary ${className}`}
