export function CertificatesPageFeature() {
  return (
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <div key={cert.id} className="pt-6">
              <div className="flow-root bg-surface-muted rounded-lg px-6 pb-8 border border-border-subtle text-center">
                <h3 className="mt-8 text-lg font-medium text-text-primary tracking-tight">{cert.title}</h3>
                <p className="mt-5 text-base text-text-muted">{cert.desc}</p>
                <div className="mt-6">
